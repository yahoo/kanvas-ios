...
@objc final public class StylableImageView: UIImageView, MovableViewInnerElement, NSSecureCoding {
    ...
    public var viewCenter: CGPoint = .zero
    ...
    public func hitInsideShape(point: CGPoint) -> Bool {
