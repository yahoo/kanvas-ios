# -*- encoding: utf-8 -*-
# stub: google-apis-androidpublisher_v3 0.23.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<google-apis-core>.freeze, [">= 0.6", "< 2.a"])
    else
      s.add_dependency(%q<google-apis-core>.freeze, [">= 0.6", "< 2.a"])
    end
  else
    s.add_dependency(%q<google-apis-core>.freeze, [">= 0.6", "< 2.a"])
  end
